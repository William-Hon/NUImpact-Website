...
const ApplySection = () => {
    return (
        <section className="py-20 px-4" style={{ backgroundColor: 'var(--color-nuimpact-blue)' }}>
                ...
                <div className="relative">
                    ...
                    <div className="border-4 border-white p-12 md:p-16">
                        ...
                        <div className="text-center text-white">
                            ...
                            <button className="px-10 py-4 bg-white text-[var(--color-nuimpact-blue)] font-bold text-lg rounded-full hover:scale-105 transition-transform duration-300 shadow-lg uppercase tracking-wide">
                                Apply Now
                            </button>
                        </div>
                    </div>
